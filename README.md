...
There are two ways to get started: using the Abbrew system generator command or manually renaming and updating files.
...
Before installing this system, you should rename any files that have `abbrew` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `abbrew` and `Abbrew` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Abbrew System](https://gitlab.com/asacolips-projects/foundry-mods/vue3abbrew) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/abbrew.png)
