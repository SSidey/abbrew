  ...
  async checkArmourForm(armourPiece) {
    ...
    for (const anatomyPoint of anatomyPoints) {
      if (!ignoreAnatomyPoint.includes(anatomyPoint.value)) {
        ...
        if ((anatomyPoints.filter(a => a.value == anatomyPoint.value).length + equippedAnatomy.filter(a => a == anatomyPoint.value).length) == choices.length) {
          choices.forEach(c => equippedIds.push(c.id));
