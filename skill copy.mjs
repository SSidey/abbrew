import { applyOperator, getOrderForOperator } from "./module/helpers/operators.mjs";
import { compareModifierIndices, getObjectValueByStringPath, getSafeJson } from "./module/helpers/utils.mjs"
import { mergeWoundsWithOperator } from "./module/helpers/combat.mjs";
import { getFundamentalAttributeSkill } from "./module/helpers/fundamental-skills.mjs";
...
function applyFullyParsedModifiers(parsedModifiers, actor, updatePath) {
    const update = {};
