...
class AbbrewActor extends Actor {
  constructor() {
    ...
    __publicField(this, "boundedAddition", function(i, j, min, max) {
      if (isNaN(min))
        min = -Infinity;
      if (isNaN(max))
        max = Infinity;
...
class AbbrewItemSheet extends ItemSheet {
  ...
  activateListeners(html) {
    ...
    if (form) {
      ...
      new tagify_minExports(form, settings);
    }
    ...
    if (anatomy) {
      ...
      new tagify_minExports(anatomy, settings);
    }
    ...
    if (type) {
      ...
      new tagify_minExports(type, settings);
    }
    ...
    if (type) {
      ...
      new tagify_minExports(armourPoints, settings);
    }
